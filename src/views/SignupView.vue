...
<template>
  ...
  <div class="w-full max-w-md">
    <div class="bg-[#dacfed] rounded-3xl border-3 border-[#676767] px-8 pt-6 pb-8 mb-4">
      ...
      <div class="flex items-center justify-between">
        <button @click="signup"
          ...
          class="bg-black hover:bg-[#ffda56] text-white hover:text-black hover:outline font-bold py-1 px-4 rounded-full focus:outline-none focus:shadow-outline"
        >
          Sign Up
        </button>

        <p class="text-sm text-end">Already registered? <br> <router-link to="/login" class="font-bold text-blue-500 hover:text-blue-800">Sign in</router-link></p>
